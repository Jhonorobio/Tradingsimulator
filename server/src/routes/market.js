...
const VALID_TABS = ['new_creation', 'completed', 'new_creation_robinhood', 'completed_robinhood', 'token_info'];
  ...
  try {
    ...
    if (trench) {
      return res.json({
        ...
        volume1h: trench.volume_1h ?? 0,
        swaps24h: trench.swaps_24h ?? 0,
        swaps1h: trench.swaps_1h ?? 0,
        buys24h: trench.buys_24h ?? 0,
        sells24h: trench.sells_24h ?? 0,
        netBuy24h: trench.net_buy_24h ?? 0,
        priceChange: null,
        holders: trench.holder_count ?? null,
        top10HolderRate: trench.top_10_holder_rate ?? null,
        smartDegenCount: trench.smart_degen_count ?? null,
        renownedCount: trench.renowned_count ?? null,
        sniperCount: trench.sniper_count ?? null,
        rugRatio: trench.rug_ratio ?? null,
        isWashTrading: trench.is_wash_trading ?? null,
        isHoneypot: trench.is_honeypot ?? null,
        bundlerRate: trench.bundler_trader_amount_rate ?? null,
        buyTax: trench.buy_tax ?? null,
        devTeamHoldRate: trench.dev_team_hold_rate ?? null,
        creatorBalanceRate: trench.creator_balance_rate ?? null,
        creatorTokenStatus: trench.creator_token_status ?? null,
        renouncedMint: trench.renounced_mint ?? null,
        renouncedFreeze: trench.renounced_freeze_account ?? null,
        dex: trench.launchpad_platform ?? null,
        dexPairs: 0,
        twitter: trench.twitter ?? null,
        telegram: trench.telegram ?? null,
        website: trench.website ?? null,
        xFollowers: trench.x_user_follower ?? null,
        ctoFlag: trench.cto_flag ?? null,
